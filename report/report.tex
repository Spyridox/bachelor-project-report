...
A planning problem\footnote{\url{http://docs.optaplanner.org/latest/optaplanner-docs/html\_single/index.html\#whatIsAPlanningProblem}} is 
...
The GraphQL interface provides queries and mutations, and they are listed in Table \ref{tab:graphql}.
\begin{table}[h]
...
& \cod{editLecture(id: Int, } \\
& \qquad \cod{lectureArg: LectureInput): Lecture} \\\hline
\end{tabularx}
